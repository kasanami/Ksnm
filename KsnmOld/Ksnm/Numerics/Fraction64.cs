...
namespace Ksnm.Numerics
{
    ...
    /// 分数
    /// </summary>
    public struct Fraction64 : IComparable, IComparable<Fraction>, IEquatable<Fraction>
    {
        #region 定数
        /// <summary>
        /// 数値 0 を表します。
        ...
        public Fraction64(Number numerator, Number denominator)
        {
            Numerator = numerator;
        ...
        /// </summary>
        /// <param name="numerator">分子</param>
        public Fraction64(Number numerator) : this(numerator, 1)
        {
        }
        /// <summary>
        /// 実数を分数に変換して初期化
        ...
        public Fraction64(double value) : this((decimal)value)
        {
#if false
        ...
        /// </summary>
        /// <param name="value">実数</param>
        public Fraction64(decimal value)
        {
            var mantissa = value.GetMantissa();
