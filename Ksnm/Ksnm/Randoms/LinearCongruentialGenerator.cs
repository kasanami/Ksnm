...
namespace Ksnm.Randoms
{
    ...
    public class LinearCongruentialGenerator : RandomBase
    {
        ...
        /// 乗数
        /// </summary>
        public ulong multiplier = 48271;
        /// <summary>
        /// 増分
        /// </summary>
        public ulong increment = 12356789;

        /// <summary>
        /// 時間に応じて決定される既定のシード値を使用し、新しいインスタンスを初期化します。
        /// </summary>
        public LinearCongruentialGenerator() : this((ulong)System.DateTime.Now.Ticks) { }
        ...
        public LinearCongruentialGenerator(int seed) : this((ulong)System.Math.Abs(seed)) { }

        /// <summary>
        /// 指定したシード値を使用して 新しいインスタンスを初期化します。
        /// </summary>
        /// <param name="seed">擬似乱数系列の開始値を計算するために使用する数値。</param>
        public LinearCongruentialGenerator(ulong seed)
        {
            this.current = seed;
        }
