...
namespace Ksnm.Units.SI
{
    ...
    public class Second<T> : Time<T> where T : IMath<T>
    {
        ...
        /// 乗算
        /// </summary>
        public static Second<T> operator *(int value, Second<T> quantity)
        {
            return new Second<T>(quantity.Value.Multiply(value));
        }
        /// <summary>
        /// 乗算
        /// </summary>
        public static Second<T> operator *(decimal value, Second<T> quantity)
        {
            return new Second<T>(quantity.Value.Multiply(value));
        }
        #endregion 演算子
